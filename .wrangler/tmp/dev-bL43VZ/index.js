// .wrangler/tmp/bundle-v55swG/checked-fetch.js
...
var about_default = [
  {
    ...
    content: "Mi acercamiento al desarrollo web inicia por mi curiosidad por saber como funcionan las cosas, esa curiosidad crece con los a\xF1os conociendo Javascript del lado del Frontend junto con React y del lado del Backend con NodeJS. Soy autodidacta en constante aprendizaje."
  }
];
...
var hero_default = [
  {
    ...
    description: "Entusiasta de las nuevas tecnolog\xEDas",
    img: "https://i.imgur.com/uyUHxN6.png"
  }
];
    ...
    projects: [
      {
        id: "1",
        name: "MovieMon",
        img: "/static/projects/moviemon.webp",
      ...
      {
        id: "10",
        name: "Configurador Hyundai 2020-2022",
      ...
      {
        id: "11",
        name: "Configurador Hyundai 2022",
...
var social_default = [
  {
    ...
    urlPortfolio: "https://firebasestorage.googleapis.com/v0/b/portfolio-6f7e5.appspot.com/o/cv-abrahamserrano-en2_compressed.pdf?alt=media&token=c337f908-af7b-487b-82b3-ea52ab04bba9"
  }
];
...
app.get("/hero", (ctx) => {
  return ctx.json(hero_default);
});
app.get("/skills", (ctx) => {
  return ctx.json(skills_default);
});
app.get("/projects", (ctx) => {
  return ctx.json(projects_default);
});
app.get("/about", (ctx) => {
  return ctx.json(about_default);
});
app.get("/contact", (ctx) => {
  return ctx.json(contact_default);
});
app.get("/social", (ctx) => {
  return ctx.json(social_default);
});
app.use("assets/static/*", serveStatic({ root: "./" }));
app.notFound((ctx) => {
...
// .wrangler/tmp/bundle-v55swG/middleware-insertion-facade.js
var __INTERNAL_WRANGLER_MIDDLEWARE__ = [
  middleware_ensure_req_body_drained_default,
  middleware_miniflare3_json_error_default
];
var middleware_insertion_facade_default = apiHono_default;
...
// .wrangler/tmp/bundle-v55swG/middleware-loader.entry.ts
